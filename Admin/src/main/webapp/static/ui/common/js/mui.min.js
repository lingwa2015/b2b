...
function(a, b, c) {
    if (!b.FastClick) {
        var d = function(a, b) {
            return ! b.type || "radio" !== b.type && "checkbox" !== b.type || b.disabled ? !1 : b
        };
        a.registerTarget({
            name: c,
            index: 40,
...
function(a, b) {
    a(function() {
        if (a.os.ios) {
            ...
            function(a) {
                var h = a.target;
                if (h.tagName && "INPUT" === h.tagName && "text" === h.type) {
...
function(a, b) {
    ...
    r = {
        ...
        _initPulldownRefresh: function() {
            ...
            this.pullPocket.classList.add(l),
...
function(a, b) {
    if (a.os.plus && a.os.android) {
        ...
        f = a.Class.extend({
            ...
            pullupLoading: function() {
                ...
                a.isLoading || (a.isLoading = !0, a.pulldown !== !1 ? a._initPullupRefresh() : this.pullPocket.classList.add(e), setTimeout(function() {
                    a.pullLoading.classList.add(d),
                    a.pullCaption.innerHTML = "",
                    a.pullCaption.innerHTML = a.options.up.contentrefresh;
        ...
        a.fn.pullRefresh = function(d) {
            ...
            return i ? g = a.data[i] : (i = ++a.uuid, e.setAttribute("data-pullrefresh-plus-" + h, i), b.body.classList.add(c), a.data[i] = g = new f(e, d)),
            g
        }
    }
} (mui, document),
function(a, b, c, d) {
    ...
    function(b) {
        if (a.targets.offcanvas) for (var d = b.target; d && d !== c; d = d.parentNode) if ("A" === d.tagName && d.hash && d.hash === "#" + a.targets.offcanvas.id) {
            a(a.targets._container).offCanvas("toggle"),
...
function(a, b, c, d) {
    ...
    u = function(d, e, h) {
        if (d && e) {
            ...
            x = "top";
            l + r < p.top - b.pageYOffset ? s = p.top - l - r: l + r < j - (p.top - b.pageYOffset) - o ? (x = "bottom", s = p.top + o + r) : (x = "middle", s = Math.max((j - l) / 2 + b.pageYOffset, 0), t = Math.max((i - k) / 2 + b.pageXOffset, 0)),
            "top" === x || "bottom" === x ? (t = n / 2 + p.left - k / 2, u = t, w > t && (t = w), t + k > i && (t = i - k - w), q && ("top" === x ? q.classList.add(m) : q.classList.remove(m), u -= t, v = k / 2 - r / 2 + u, v = Math.max(Math.min(v, k - 2 * r - 6), 6), q.setAttribute("style", "left:" + v + "px"))) : "middle" === x && q.setAttribute("style", "display:none"),
            d.setAttribute("style", "display:block;top:" + s + "px;left:" + t + "px;")
        }
    };
...
function(a, b, c, d) {
    ...
    function(b) {
        var j = a.targets.tab;
        if (j) {
            var k, l, m, n = "mui-active",
            o = "." + n;
            for (segmentedControl = j.parentNode; segmentedControl && segmentedControl !== c; segmentedControl = segmentedControl.parentNode) {
                if (segmentedControl.classList.contains(f)) {
                    k = segmentedControl.querySelector(o + "." + e);
                    break
                }
                segmentedControl.classList.contains(h) && (k = segmentedControl.querySelector(o + "." + i))
            }
            k && k.classList.remove(n);
            var p = j === k;
            if (j && j.classList.add(n), j.hash && (m = c.getElementById(j.hash.replace("#", "")))) {
                if (!m.classList.contains(g)) return void j.classList[p ? "remove": "add"](n);
                if (!p) {
                    var q = m.parentNode;
                    l = q.querySelectorAll("." + g + o);
                    for (var r = 0; r < l.length; r++) {
                        var s = l[r];
                        s.parentNode === q && s.classList.remove(n)
                    }
                    m.classList.add(n);
                    var t = m.parentNode.querySelectorAll("." + g);
                    a.trigger(m, a.eventName("shown", d), {
                        tabNumber: Array.prototype.indexOf.call(t, m)
                    }),
...
function(a, b, c) {
    ...
    var j = function(a) {
        ...
        this.handle = this.element.querySelector(h),
        this.init(),
        this.initEvent()
    };
    ...
    a.fn["switch"] = function() {
        ...
        return this.each(function() {
            ...
            d ? c = a.data[d] : (d = ++a.uuid, a.data[d] = new j(this), this.setAttribute("data-switch", d)),
            b.push(c)
        }),
        b.length > 1 ? b: b[0]
    },
    ...
    var E = {
        ...
        dragend: function(b) {
            if (y) {
                ...
                var l;
                if (buttonsLeft && buttonsLeft.length > 0 && buttonsLeft !== i) for (var m = 0,
                n = buttonsLeft.length; n > m; m++) {
                    var o = buttonsLeft[m];
                    l = o._buttonOffset,
                    "undefined" == typeof l && (o._buttonOffset = sliderActionLeftWidth - o.offsetLeft - o.offsetWidth),
                    D(o, l)
                }
                if (buttonsRight && buttonsRight.length > 0 && buttonsRight !== i) for (var m = 0,
                n = buttonsRight.length; n > m; m++) {
                    var p = buttonsRight[m];
                    l = p._buttonOffset,
                    "undefined" == typeof l && (p._buttonOffset = p.offsetLeft),
                    D(p, -l)
                }
            }
        }
    ...
    a.fn.input = function() {
        this.each(function() {
            ...
            if ("range" === this.type && c.classList.contains("mui-input-range")) b.push("slider");
                ...
                f.contains("mui-input-clear") && b.push("clear"),
                f.contains("mui-input-speech") && b.push("speech"),
            ...
            if (!g) {
                ...
                for (var h = 0,
                i = b.length; i > h; h++) this.setAttribute("data-input-" + b[h], g)
            }
        })
    },
    a.ready(function() {
