...
@Controller
@RequestMapping("bwVariety")
public class BlackWhiteListVarietyController {
private static final Logger logger = LoggerFactory.getLogger(BlackWhiteListVarietyController.class);
	...
	public String delete(int id){
		String result = "操作成功";
		try{
			this.blackwhitelistVarietyService.deleteById(id);
		}catch(Exception e){
            logger.error("删除黑白名单品种失败",e);
