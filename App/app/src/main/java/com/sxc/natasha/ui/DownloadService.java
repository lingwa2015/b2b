...
import com.sxc.natasha.ui.NotificationUpdateActivity.ICallbackResult;
...
/**
 * Description: DownloadService 下载APK service
 *
 * @author:     zhengshutian
 * @version:    1.0
 ...
 * ------------------------------------------------------------------
 * 2015-03-23      zhengshutian    1.0         1.0 Version
 */
public class DownloadService extends Service {
    ...
    private void setUpNotification() {
        ...
        contentView.setTextViewText(R.id.name, "宋小菜.apk 正在下载...");
        // 指定个性化视图
    ...
    private void installApk() {
        File apkfile = new File(SXC_API.DOWNLOAD_SAVE_NAME);
        if (!apkfile.exists()) {
            return;
        }
    ...
    private Runnable mdownApkRunnable = new Runnable() {
        ...
        public void run() {
            try {
                URL url = new URL(SXC_API.DOWNLOAD_APK_URL);
                ...
                File file = new File(SXC_API.DOWNLOAD_SAVE_PATH);
                if (!file.exists()) {
                    file.mkdirs();
                }
                String apkFile = SXC_API.DOWNLOAD_SAVE_NAME;
