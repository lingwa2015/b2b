...
public class ItemMonthReport {
    ...
    private Integer storageOrderNum;
    ...
    public Integer getStorageOrderNum() {
        return storageOrderNum;
    }

    public void setStorageOrderNum(Integer storageOrderNum) {
        this.storageOrderNum = storageOrderNum;
    }
